        ...
        @include('tools.sidebar')           
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <form action="{{url ('Simpan_Protes')}}" method="post">
                        {{csrf_field()}}
                    ...
                    <h2 class="card-title"><small style="color: white;">Input Wilayah</small></h2>
                            ...
                            <div class="form-group">
                               ...
                               @endforeach
                                     ...
                                     <div class="form-group">
                                         <input type="text" class="form-control" name="daftar_srt" placeholder="Daftar Surat">
                                     </div>

                                     <div class="form-group">
                                         <input type="text" class="form-control" name="tgl_no" placeholder="Tanggal Nomor">
                                     </div>
