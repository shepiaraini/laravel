                ...
                <section class="content-header">
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
                       <div class="card-header">
                         ...
                         <a href="{{ url ('Tambah_Wilayah') }}" class="btn btn-primary">Tambah</a>
                         </div>
                         ...
                         <div classs="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url ('edit-wilayah', $item->id)}}"><i class="fas fa-edit text-primary"></i></a>
                                        <a href="{{url ('delete-wilayah', $item->id)}}"><i class="fas fa-trash-alt text-red"></i></a>
