            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1 class="text-center">
                       ISI DATA NOTARIS PENGGANTI     
                    </h1>
               
                
                    <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
                    <form action="{{url ('Simpan_Notpengganti')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                    ...
                    <h2 class="card-title"><small style="color: white;">Input Wilayah</small></h2>
                                    ...
                                    <input type="text" class="form-control" name="id" placeholder="NIK" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file"  name="daftar_riwayat"> 
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="exampleInputFile">FC KTP</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputFile">SURAT KET SEHAT</label>
                                            <input type="file"  name="srt_sehat"> 
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputFile">SURAT KET KERJA</label>
                                            <input type="file"  name="srt_kerja"> 
                                        </div>
