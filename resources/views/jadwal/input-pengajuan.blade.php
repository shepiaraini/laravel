            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1 class="text-center">
                       INPUT PENGAJUAN PELANTIKAN NOTARIS   
                    </h1>
               
                
                    <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
                    <form action="{{url ('Simpan_Pengajuan')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                                    <div class="box-body">
                            ...
                            <div class="form-group">
                               ...
                               @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="waktu_cuti" placeholder="Waktu Cuti">
                                        </div>
